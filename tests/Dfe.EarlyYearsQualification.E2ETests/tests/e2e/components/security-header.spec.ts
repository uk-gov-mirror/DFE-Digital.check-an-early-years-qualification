...
const expectedContentSecurityPolicyHeader = "script-src 'self' 'unsafe-hashes' 'sha256-GUQ5ad8JK5KmEWmROf3LZd9ge94daqNvd8xy9YS1iDw=' 'sha256-GpJWMv4RFVtMmtpVesvi1tYdRYY/EzVguE7Ti05N3+Y=' https://www.googletagmanager.com/gtm.js https://www.googletagmanager.com/gtag/js https://*.clarity.ms https://c.bing.com;object-src 'self';frame-ancestors https://app.contentful.com;connect-src *.google-analytics.com https://*.clarity.ms/collect 'self';block-all-mixed-content;upgrade-insecure-requests;"
